  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved relation as @relation" do
        ...
        post :create, {:relation => { "item_id" => "invalid value" }}, valid_session
        assigns(:relation).should be_a_new(Relation)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested relation" do
        ...
        Relation.any_instance.should_receive(:update_attributes).with({ "item_id" => "1" })
        put :update, {:id => relation.to_param, :relation => { "item_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the relation as @relation" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Relation.any_instance.stub(:save).and_return(false)
        put :update, {:id => relation.to_param, :relation => { "item_id" => "invalid value" }}, valid_session
        assigns(:relation).should eq(relation)
      end
