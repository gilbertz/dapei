# -*- encoding : utf-8 -*-
class DarenAppliesController < ApplicationController
  ...
  def index
    @daren_applies = DarenApply.order("created_at desc")
  ...
  def update
    ...
    respond_to do |format|
      if @daren_apply.update_attributes(params[:daren_apply])
        ...
        format.html { redirect_to @daren_apply, notice: 'Daren apply was successfully updated.' }
