	...
	var Product = function(imgNode) {
		...
		var getMetaInfo = function() {
			...
			function _getSingleProduct() {
				...
				if (typeof(jsinit_item) != "undefined") {
					result.refNo = jsinit_item.CURRENTITEM.code;
				}
				
                if ($('#itemColors img').length > 0) {
                    var colors = [];
                    $('#itemColors img').each(function() {
                        var colorOption = {};
				...
				if ($("div .js_size .js_option").length > 0) {
					var sizes = [];
					$("div .js_size .js_option").each(function() {
