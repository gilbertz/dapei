    ...
    var Product = function(imgNode) {
        ...
        var getMetaInfo = function() {
            ...
            function _getSingleProduct() {
                var nameNode = $("div.iteminfo .f_l"),
                refNode = $("ul.info li:first dd"),
                priceNode = $("font.market"),
                colorNodes = $("ul.ul-color-pic:first li"),
                sizeNodes = $("ul.ul-color-pic:last li");
                ...
                if (refNode.length > 0) {
                    result.refNo = refNode.contents()[1].data.trim();                            
                }
                ...
                if (sizeNodes.length > 0) {
                    ...
                    sizeNodes.each(function() {
                        sizes.push($(this).attr("title").trim());
                    });
