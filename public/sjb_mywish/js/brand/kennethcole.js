    ...
    var Product = function(imgNode) {
        ...
        var getMetaInfo = function() {
            ...
            function _getSingleProduct() {
                var nameNode = $("#productInfoTop h1:first"),
                refNode = $("#productInfoTop h3:first"),
                priceNode = $("#productInfoTop h2:first"),
                colorNodes = $("#productInfoR2W img"),
                sizeNodes = $("select.productSizeSelect option");
                ...
                if($("div.W300").length > 0) {
                    var price = $("div.W300:first").text().replace("Sale Now", "").trim();
                    if(price) {
                ...
                if (priceNode.length > 0) {
                    if (priceNode.hasClass("sale-now") > 0) {
                        result.oriPrice = priceNode.contents().eq(0).text().trim();
                        result.promotionPrice = result.promotionPrice || priceNode.contents()[1].data.trim();
                    } else {
