    ...
    var Product = function(imgNode) {
        ...
        var getMetaInfo = function() {
            ...
            function _getSingleProduct() {
                var nameNode = $("div.p_title"),
                refNode = $("div.number"),
                priceNode = $("#prd_price_div p.col1"),
                colorNodes = $("#colorsArea li a"),
                sizeNodes = $("#sizesArea li a");
                ...
                }else if(priceNode.length > 1) {
                    result.oriPrice = priceNode.eq(1).text().trim();
                    result.promotionPrice = priceNode.eq(0).text().trim();
                }
                ...
                if (colorNodes.length > 0) {
                    ...
                    colorNodes.each(function() {
                        ...
                        if ($(this).parent().hasClass("option-value-selected")) {
