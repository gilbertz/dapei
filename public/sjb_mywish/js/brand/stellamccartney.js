...
var Product = function(imgNode) {
    ...
    var getMetaInfo = function() {
        ...
        function _getSingleProduct() {
            ...
            if ($("div.newprice span.priceValue").length > 0) {
                result.oriPrice = $("div.newprice span.priceValue").text().trim();
            }
            
            if ($("div.oldprice span.priceValue").length > 0) {
                result.promotionPrice = $("div.oldprice span.priceValue").text().trim();
            }
            
            if ($("#modelfabriccolor").length > 0) {
                result.refNo = $("#modelfabriccolor").text().trim().substring(6).trim();
            }
