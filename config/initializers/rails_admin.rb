# -*- encoding : utf-8 -*-
# RailsAdmin config file. Generated on November 06, 2012 21:16
# See github.com/sferik/rails_admin for more informations

require Rails.root.join('lib', 'rails_admin_manage_user.rb')
require Rails.root.join('lib', 'rails_admin_activate_shop.rb')
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Shangjieba', 'Admin']
